...
<!-- 댓글 시작 -->
	...
	<div style="margin: auto;">
		<form action="/comment/updateComment.do" method="post">
			<p>
				<label>작성자</label>&emsp;<input type="text" name="writer" readonly="readonly" value="${commentVO.writer }">
			</p>
			<p>
				<textarea rows="5" cols="50" name="content" style="resize:none; border: 1px #E0E0E0 solid; border-radius: 10px; padding: 8px; width: 800px;">${commentVO.content }</textarea>
			</p>
			<p>
				<input type="hidden" name="boardNo" value="${commentVO.boardNo }">
				<input type="hidden" name="cno" value="${commentVO.cno }">
				<button type="submit" id="commentInsertBtn">댓글 수정</button>
			</p>
		</form>
	</div>
<!-- 댓글 끝 -->
